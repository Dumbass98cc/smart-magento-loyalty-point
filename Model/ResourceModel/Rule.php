...
class Rule extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function getCustomerGroupIds($ruleId)
    {
        $select = $this->getConnection()->select()->from(
            $this->getTable("loyalty_rewardrule_customer_group"),
            ['customer_group_id']
        )->where(
            'rule_id' . ' = ?',
            $ruleId
     ...
     */
    public function setCustomerGroupId($ruleId, $customerGroupId)
    {
        $query = "INSERT INTO loyalty_rewardrule_customer_group
                  VALUES ($ruleId, $customerGroupId)";
     ...
     * @param $ruleId
     */
    public function deleteCustomerGroupIds($ruleId)
    {
        $query = "DELETE FROM loyalty_rewardrule_customer_group
